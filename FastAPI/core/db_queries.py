...
def fetch_parts_count_by_supplier(engine, query_text=None):
...
def part_distrubution_by_country(engine, query_text=None):
...
def top_5_parts_by_price(engine, query_text=None):
